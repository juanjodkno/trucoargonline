...
exports.hasFlor = hasFlor;
exports.calculateFlor = calculateFlor;
exports.getEnvidoDetails = getEnvidoDetails;
exports.calculateEnvido = calculateEnvido;
exports.CARDS_DATA = [
    // 1 de Espada (Macho)
...
function createDeck() {
    return exports.CARDS_DATA.map(c => ({
        ...c,
...
function getEnvidoDetails(cards) {
    if (!cards || cards.length === 0)
        return { score: 0, envidoCards: [] };
    const suitsMap = {};
    cards.forEach(c => {
    ...
    if (maxScore === -1) {
        ...
        cards.forEach(c => {
            if (c.envidoValue > highestCard.envidoValue)
                highestCard = c;
        });
